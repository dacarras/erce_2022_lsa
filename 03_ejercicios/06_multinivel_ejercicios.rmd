...
remotes::install_github("tslumley/svylme", force = TRUE)
...
summary(wemix_pv_results[[1]])


dplyr::glimpse(wemix_pv_results[[1]])
...
#------------------------------------------------
# tabla componentes de varianza
#------------------------------------------------

tabla_1_6_var <- summary(
  miceadds::pool_mi(
  qhat = list(
    wemix_pv_results[[1]]$vars,
    wemix_pv_results[[2]]$vars,
    wemix_pv_results[[3]]$vars,
    wemix_pv_results[[4]]$vars,
    wemix_pv_results[[5]]$vars
    ), 
  se   = list(
    wemix_pv_results[[1]]$varDF$SEvcov,
    wemix_pv_results[[2]]$varDF$SEvcov,
    wemix_pv_results[[3]]$varDF$SEvcov,
    wemix_pv_results[[4]]$varDF$SEvcov,
    wemix_pv_results[[5]]$varDF$SEvcov
    )
  )
) %>%
tibble::rownames_to_column("term") %>%
